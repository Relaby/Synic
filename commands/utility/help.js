...
if(message.content.toLowerCase() === `${prefix}help`){
    ...
    .setColor(`#dbbbff`)
    .setTitle("Synic Help Menu")
    .addField('Prefix Information', `Prefix: \`+\`\nYou can also mention \`Synic\` to get prefix info.`)
    .setDescription(
    ...
    .addField(` **❯ LINKS **`,`   [Invite Me](https://discord.com/oauth2/authorize?client_id=849116086195716106&scope=bot&permissions=805306424)`+` - `+`[Support Server](https://discord.gg/jDA5VzVFbp)`)
    .setFooter("© Synic")
    .setTimestamp()
